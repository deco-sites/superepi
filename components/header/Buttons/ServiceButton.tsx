            ...
            {openPopUp.value && (
                ...
                >
                    ...
                    <button class='flex flex-col justify-center items-center w-full border border-[#808080] py-2 px-4'>
                        <span class='font-bold'>Horário de atendimento</span> <br /> Segunda à
                        Quinta <br /> das 9:00H às 18:00H <br /> Sexta <br />
                        das 8:00H às 17:00H
                    </button>
                    <span class='font-bold px-3'>Horário de atendimento Loja</span> <br /> Segunda à
                    Quinta <br /> das 9:00H às 17:30H <br /> Sexta <br />
                    das 8:00H às 16:30H
                </div>
            )}
        </div>
