          ...
          <div
            ...
            <ul class="py-6 px-6 max-h-[550px] bg-white">
              {children.map((node, index) => (
                <li class="p-1">
                  <a class={`hover:underline hover:text-[#F8A531] transition-all duration-500 text-xs ${indexListItems.value === index && "underline text-[#F8A531]"}`} onMouseEnter={() => indexListItems.value = index} href={node.href}>
