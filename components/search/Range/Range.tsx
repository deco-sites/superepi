...
export const Range = ({
  ...
  return (
    <div className="sm:flex sm:flex-col sm:gap-[1.25rem] sm:w-full">
      <div className="sm:flex sm:items-center sm:relative sm:w-full">
        <div className="sm:bg-[#ddd] sm:flex sm:h-1 sm:items-center sm:relative sm:w-full">
          <div
            className="sm:absolute sm:bg-[#cf6196] sm:h-full sm:flex"
            style={{
        ...
        <label className="sm:absolute sm:flex sm:w-full">
          <span className="sm:absolute sm:h-0 sm:overflow-hidden sm:w-0">
            Preço mínimo
          </span>
      ...
      <div className="sm:gap-2 sm:flex sm:flex-wrap sm:items-center sm:justify-between sm:w-full">
        <button
          className={clx(
        ...
        <span className="sm:font-normal sm:leading-normal sm:text-sm sm:text-[#646a7c]">
