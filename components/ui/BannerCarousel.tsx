        ...
        >
            ...
            {action?.title && (
                <div class='absolute h-min top-0 bottom-0 m-auto left-0 right-0 sm:right-auto sm:left-[12%] max-h-min max-w-[235px] flex flex-col gap-4 p-4 rounded glass'>
                    ...
                    <span class='font-medium text-xl text-base-100'>{action.subTitle}</span>
        ...
        <>
            <div class='flex items-center justify-center z-10 col-start-1 row-start-2'>
                <Slider.PrevButton class='btn btn-circle bg-transparent hover:bg-[#f8a531] transition-all duration-500 rounded-none'>
                    <Icon class='text-base-100' size={24} id='ChevronLeft' strokeWidth={3} />
                </Slider.PrevButton>
            </div>
            <div class='flex items-center justify-center z-10 col-start-3 row-start-2'>
                <Slider.NextButton class='btn btn-circle bg-transparent hover:bg-[#f8a531] transition-all duration-500 rounded-none'>
                    <Icon class='text-base-100' size={24} id='ChevronRight' strokeWidth={3} />
                </Slider.NextButton>
            </div>
        </>
    )
