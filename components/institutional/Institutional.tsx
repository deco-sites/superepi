...
export const loader = (props: Props, req: Request) => {
  ...
  const article = articles.find(({ matcher }) => new RegExp(`^${matcher}`).test(pathname));
    ...
    <div className="sm:flex sm:w-full">
      <div className={clx(
        ...
        <div className="sm:flex sm:flex-col sm:max-w-page-container sm:mx-auto sm:w-full">
          <Breadcrumb
            itemListElement={[
              { "@type": "ListItem", item: "/", position: 0, name: "Página Inicial" },
              { "@type": "ListItem", item: "/", position: 1, name: article?.name }
            ]}
          />
