...
export const Product = ({ product }: ProductProps) => {
    ...
    return (
        <article class='group sm:duration-300 sm:ease-in-out sm:flex sm:flex-col sm:gap-4 sm:h-full sm:p-4 sm:relative sm:transition-shadow sm:w-full'>
            <Image
                alt=''
            ...
            <div class='sm:flex sm:flex-col sm:gap-6 sm:h-full sm:w-full'>
                ...
                <div class='sm:flex sm:flex-col sm:items-start sm:justify-center sm:mt-auto sm:w-full'>
