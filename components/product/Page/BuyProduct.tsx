...
export const BuyProduct = ({ product }: BuyProductProps) => {
    ...
    const tabelaDeMedidas = rawProduct.Model.Descriptions.find(i => i.Name === 'Tabela')?.Value
        ...
        <>
            ...
            <div class='flex flex-col gap-6 w-full lg:max-w-[29%]'>
                    ...
                    {tabelaDeMedidas && (
                        <tabelaDeMedidasModal.Toggle class='flex items-center gap-2 cursor-pointer w-full mt-2.5'>
                            <img
                                ...
                                loading='lazy'
                            />
                            <span class='underline text-[#999999] text-xs'>Tabela de Medidas</span>
                        </tabelaDeMedidasModal.Toggle>
                    )}
                </div>
                ...
                <div class='flex flex-col w-full'>
                    <div class='flex flex-col w-full'>
                        {listPrice > price && (
                            <span class=''>{formatPrice(listPrice, offers?.priceCurrency)}</span>
                        )}
                    ...
                    {fichaTecnica && (
                        <fichaTecnicaModal.Toggle class='flex items-center gap-2 cursor-pointer w-full'>
                            <img
                                ...
                                loading='lazy'
                            />
                            <span class='underline text-[#999999] text-xs'>Ficha Técnica</span>
                        </fichaTecnicaModal.Toggle>
                    )}
                </div>
