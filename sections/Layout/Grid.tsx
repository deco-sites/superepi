...
import { VNode, grid } from '../../constants.tsx'
    ...
    return (
        <div
            class={clx(
                ...
                layout?.placeItems?.mobile && grid.placeItems.mobile[layout.placeItems.mobile],
                layout?.placeItems?.desktop && grid.placeItems.desktop[layout.placeItems.desktop],
            )}
        >
            {children}
        </div>
